...
class SupplierResourceIT {
    ...
    public static Supplier createEntity() {
        return new Supplier().name(DEFAULT_NAME).contactInfo(DEFAULT_CONTACT_INFO).address(DEFAULT_ADDRESS);
    }
    ...
    public static Supplier createUpdatedEntity() {
        return new Supplier().name(UPDATED_NAME).contactInfo(UPDATED_CONTACT_INFO).address(UPDATED_ADDRESS);
    }
    ...
    void getAllSuppliers() throws Exception {
        ...
        restSupplierMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(supplier.getId().toString())))
    ...
    void getNonExistingSupplier() throws Exception {
        // Get the supplier
        restSupplierMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putExistingSupplier() throws Exception {
        ...
        updatedSupplier.name(UPDATED_NAME).contactInfo(UPDATED_CONTACT_INFO).address(UPDATED_ADDRESS);
    ...
    void putWithIdMismatchSupplier() throws Exception {
        ...
        restSupplierMockMvc
            .perform(
                put(ENTITY_API_URL_ID, UUID.randomUUID()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(supplierDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void partialUpdateSupplierWithPatch() throws Exception {
        ...
        partialUpdatedSupplier.name(UPDATED_NAME).contactInfo(UPDATED_CONTACT_INFO).address(UPDATED_ADDRESS);
    ...
    void deleteSupplier() throws Exception {
        ...
        // Delete the supplier
        restSupplierMockMvc
            .perform(delete(ENTITY_API_URL_ID, supplier.getId().toString()).accept(MediaType.APPLICATION_JSON))
