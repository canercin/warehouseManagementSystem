...
import { sampleWithRequiredData } from '../batch.test-samples';
...
describe('Batch Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.batches?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to batchService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getBatchIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBatchIdentifier).toHaveBeenCalledWith(entity);
